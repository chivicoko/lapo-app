...
const ButtonOne: React.FC<ButtonProps> = ({
  ...
  return (
    <button
      ...
      className={`flex items-center justify-center gap-2 text-white hover:text-primary bg-primary hover:bg-transparent border border-transparent hover:border-primary rounded-radius-4 hover:cursor-pointer shadow-custom-xl focus:ring-2 focus:ring-primary focus:ring-offset-2 outline-none ${classes} ${pending || disabled ? 'opacity-50 cursor-not-allowed' : ''}`}
